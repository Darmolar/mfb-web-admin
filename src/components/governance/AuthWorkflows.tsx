        ...
        {workflows.map(w => (
          <div key={w.id} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
            ...
            <div>
              ...
              <select className="w-full text-xs border border-slate-200 rounded-lg px-3 py-2 bg-slate-50 text-slate-700 focus:outline-none">
